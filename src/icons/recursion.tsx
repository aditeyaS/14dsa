...
export const RecursionIcon: React.FC = () => {
  return (
    <svg className="h-24 w-24" viewBox="0 0 24 24" fill="none">
      <circle cx="6.5" cy="17.5" r="4" className="stroke-primary" />
      <line x1="6" y1="2.5" x2="22" y2="2.5" className="stroke-primary" />
      <line x1="21.5" y1="18" x2="21.5" y2="2" className="stroke-primary" />
      <path
      ...
      />
      <line x1="10" y1="17.5" x2="22" y2="17.5" className="stroke-primary" />
    </svg>
  );
};
